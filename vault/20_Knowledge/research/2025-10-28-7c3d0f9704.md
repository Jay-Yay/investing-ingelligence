...
description: oaktree의 2025-10-28 리서치 「A Look Under the Hood」. oaktree — A Look Under the Hood (첨부된 PDF
  리포트에서 추출한 원문 전체) © 2025 Oaktree Capital Management, L.
resource: https://www.oaktreecapital.com/insights/memo/a-look-under-the-hood
tags:
- ib_insights
- ch-ib-oaktree
- en
...
provenance:
  system: ib_insights
  content_hash: 7c3d0f9704d89b04
  source_path: vault/10_Sources/IB/oaktree/2025/2025-10-28-7c3d0f9704d89b04.md
---

# 요약

oaktree의 2025-10-28 리서치 「A Look Under the Hood」. oaktree — A Look Under the Hood (첨부된 PDF 리포트에서 추출한 원문 전체) © 2025 Oaktree Capital Management, L.

# 원문

## 원문
oaktree — A Look Under the Hood
...
to reach the sum needed to pay future benefits. So, if the plan’s actuarial assumption is 61⁄4%, what 
...
The challenge in assessing performance in this regard stems from the fact that making 61⁄4% may be 
the only thing that matters in the long run but absolutely irrelevant in the short run. If the 60/40 
balanced portfolio, the policy portfolio, or the peer average is up 20% next year, achieving 61⁄4% can’t be 
described as success. And if those relative benchmarks are down 20% next year, making 61⁄4% is 
...
## 출처
- [원문](https://www.oaktreecapital.com/insights/memo/a-look-under-the-hood)
...
- 수집 시스템: `ib_insights`
- 원본 파일: `vault/10_Sources/IB/oaktree/2025/2025-10-28-7c3d0f9704d89b04.md`
- 내용 해시: `7c3d0f9704d89b04…`
- 원문: <https://www.oaktreecapital.com/insights/memo/a-look-under-the-hood>

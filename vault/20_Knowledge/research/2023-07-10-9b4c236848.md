...
description: oaktree의 2023-07-10 리서치 「Taking the Temperature」. oaktree — Taking the Temperature (첨부된 PDF
  리포트에서 추출한 원문 전체) © 2023 Oaktree Capital Management, L.
resource: https://www.oaktreecapital.com/insights/memo/taking-the-temperature
tags:
- ib_insights
- ch-ib-oaktree
- en
...
provenance:
  system: ib_insights
  content_hash: 9b4c236848495488
  source_path: vault/10_Sources/IB/oaktree/2023/2023-07-10-9b4c236848495488.md
---

# 요약

oaktree의 2023-07-10 리서치 「Taking the Temperature」. oaktree — Taking the Temperature (첨부된 PDF 리포트에서 추출한 원문 전체) © 2023 Oaktree Capital Management, L.

# 원문

## 원문
oaktree — Taking the Temperature
...
I
n preparation for my interview for “Lunch with the FT” last fall, I sent the reporter, Harriet Agnew, five 
...
great trepidation.) 
T
o illustrate how one might approach making market calls, I’m going to briefly summarize what led me 
...
anuary 2000 
I
n the fall of 1999, against the backdrop of the massive gains being achieved in tech, media, and telecom 
...
T
he driving force behind Oaktree’s behavior in that period wasn’t any of the above. Rather, it was the 
...
I
n short, the article’s theme was that no one would ever invest in stocks again because they had done so 
...
T
he bottom line of the above – simply put – is that we didn’t know anything about what the future held. 
...
publication of my memo The Illusion of Knowledge (S eptember 2022), which discussed why I believe 
...
I
n 1995, when my four Oaktree co-founders and I decided to form a new firm, we’d already been working 
...
You might ask here, “What about the memo Sea Change a
nd its assertion that we may be seeing a shift 
...
A
nd what about market timing? As I’ve written numerous times since developing my risk-posture 
...
## 출처
- [원문](https://www.oaktreecapital.com/insights/memo/taking-the-temperature)
...
- 수집 시스템: `ib_insights`
- 원본 파일: `vault/10_Sources/IB/oaktree/2023/2023-07-10-9b4c236848495488.md`
- 내용 해시: `9b4c236848495488…`
- 원문: <https://www.oaktreecapital.com/insights/memo/taking-the-temperature>

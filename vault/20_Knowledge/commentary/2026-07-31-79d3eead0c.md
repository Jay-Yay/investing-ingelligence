...
title: '미니맥스, 범용 멀티모달 생성 모델 MiniMax H3 발표 : 텍스트, 이미지, 비디오, 오디오를 하나의'
description: '텔레그램 채널 삼성 글로벌AI/SW 이영진의 2026-07-31 메시지. 미니맥스, 범용 멀티모달 생성 모델 MiniMax H3 발표 : 텍스트, 이미지, 비디오,
  오디오를 하나의 컨텍스트로 이해하는 범용 멀티모달 생성 모델 H3 공개 : 최대 15초, 2K 해상도 비디'
resource: https://t.me/Samsung_Global_AI_SW/4101
tags:
- telegram
- ch-telegram-samsung-global-ai-sw
- ko
timestamp: '2026-07-31T11:40:08Z'
status: stable
language: ko
capture: full
period:
...
provenance:
  system: telegram
  content_hash: 79d3eead0c7eb579
  source_path: vault/10_Sources/Telegram/Samsung_Global_AI_SW/2026/2026-07-31-79d3eead0c7eb579.md
---

# 요약

텔레그램 채널 삼성 글로벌AI/SW 이영진의 2026-07-31 메시지. 미니맥스, 범용 멀티모달 생성 모델 MiniMax H3 발표 : 텍스트, 이미지, 비디오, 오디오를 하나의 컨텍스트로 이해하는 범용 멀티모달 생성 모델 H3 공개 : 최대 15초, 2K 해상도 비디
...
- 수집 시스템: `telegram`
- 원본 파일: `vault/10_Sources/Telegram/Samsung_Global_AI_SW/2026/2026-07-31-79d3eead0c7eb579.md`
- 내용 해시: `79d3eead0c7eb579…`
- 원문: <https://t.me/Samsung_Global_AI_SW/4101>

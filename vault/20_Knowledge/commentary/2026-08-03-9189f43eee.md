...
title: '미니맥스, MiniMax H3 웨이트 공개 및 라이선스 관련 업데이트 : MiniMax H3를 오픈웨이트(Open Weight) 모델로 공개.'
description: '텔레그램 채널 삼성 글로벌AI/SW 이영진의 2026-08-03 메시지. 미니맥스, MiniMax H3 웨이트 공개 및 라이선스 관련 업데이트 : MiniMax
  H3를 오픈웨이트(Open Weight) 모델로 공개.'
resource: https://t.me/Samsung_Global_AI_SW/4114
tags:
- telegram
- ch-telegram-samsung-global-ai-sw
- ko
timestamp: '2026-08-03T06:01:16Z'
status: stable
language: ko
capture: full
period:
...
provenance:
  system: telegram
  content_hash: 9189f43eee54e909
  source_path: vault/10_Sources/Telegram/Samsung_Global_AI_SW/2026/2026-08-03-9189f43eee54e909.md
---

# 요약

텔레그램 채널 삼성 글로벌AI/SW 이영진의 2026-08-03 메시지. 미니맥스, MiniMax H3 웨이트 공개 및 라이선스 관련 업데이트 : MiniMax H3를 오픈웨이트(Open Weight) 모델로 공개.
...
- 수집 시스템: `telegram`
- 원본 파일: `vault/10_Sources/Telegram/Samsung_Global_AI_SW/2026/2026-08-03-9189f43eee54e909.md`
- 내용 해시: `9189f43eee54e909…`
- 원문: <https://t.me/Samsung_Global_AI_SW/4114>

...
description: Enphase Energy, Inc.가 2020-08-04 SEC에 제출한 10-Q. 보고 기준일 2020-06-30
resource: https://www.sec.gov/Archives/edgar/data/1463101/000146310120000107/0001463101-20-000107-index.htm
tags:
- sec_filing
- 10-Q
- us-ENPH
...
provenance:
  system: sec_filing
  native_id: 0001463101-20-000107
  content_hash: ab8e2240021f631c
  source_path: vault/10_Sources/SEC/ENPH/2020/2020-08-04-ab8e2240021f631c.md
---

# 요약

Enphase Energy, Inc.가 2020-08-04 SEC에 제출한 10-Q. 보고 기준일 2020-06-30
...
| Total | 20,770 | 66 | 5,755 | 77 |
 ...
 LONGi Solar , and Solaria Corporation. We announced a strategic partnership with Hanwha Q CELLS in the second quarter of 2020 to develop Enphase EnergizedTM Q CELLS ACM products based on seventh-generation Enphase IQ microinverters. The first Enphase Energized Q CELLS ACM products are now available from major distributors in the U.S . W e announced in July 2020 a strategic partnership with SunPower to produce the new Enphase EnergizedTM Maxeon ACM, based on our seventh-generation Enphase IQ microinverters. The ACM will be commercialized by Maxeon Solar Technologies, the planned spin-off from SunPower, and will be available to residential customers in key international markets through authorized installer networks and distributors starting in the fourth quarter of 2020. 

 Our next-generation battery in North America is Enphase Encharge 3TM or Encharge 10TM storage systems, with usable and scalable capacity of 3.4 kWh and 10.1 kWh, respectively. Enphase EnchargeTM storage systems feature Enphase embedded grid-forming microinverters that enable the Always-On capability that keeps homes powered when the grid goes down, and the ability to save money when the grid is up. These systems are compatible with both new and existing Enphase IQ solar systems with IQ 6TM or IQ 7TM microinverters and provide a simple upgrade path for our existing solar customers. We started shipping Enphase Encharge products in the second quarter of 2020. 

 Our next-generation IQ 8TM system is based upon our Always On Enphase EnsembleTM energy management technology. This system has five components: 1) energy generation, which is accomplished with the grid-agnostic microinverter IQ 8; 2) energy storage, which is achieved by the EnchargeTM battery with capacities of 3.4 kWh and 10.1 kWh; 3) EnpowerTM smart switch, which includes a microgrid interconnect device (MID); 4) communication and control via the combiner box with the Envoy gateway; and 5) Enlighten, which is the internet of things, or IoT, cloud software. 
...
- 수집 시스템: `sec_filing`
- 원 식별자: `0001463101-20-000107`
- 원본 파일: `vault/10_Sources/SEC/ENPH/2020/2020-08-04-ab8e2240021f631c.md`
- 내용 해시: `ab8e2240021f631c…`
- 원문: <https://www.sec.gov/Archives/edgar/data/1463101/000146310120000107/0001463101-20-000107-index.htm>

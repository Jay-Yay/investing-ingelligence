...
collected_at: '2026-08-01T15:00:09.715346Z'
updated_at: null
language: en
content_hash: 40bebcc9e211af7f017679ad93416ebd556456eb4e579fdd90a3f52c3342bccf
content_capture:
  mode: full
  reason: null
assets: []
...
## 핵심 주장
- Bloom Energy 창업자 겸 CEO KR Sridhar는 2분기 실적발표에서 '기존에 연소 기술을 기본 선택하던 고객들이 이제 Bloom을 우수한 전력 솔루션으로 능동적으로 선택하고 있다'며, 현재 미국 주요 하이퍼스케일러 전부와 10여 곳 이상의 미국 니오클라우드·AI랩·코로케이션 데이터센터 운영사가 Bloom의 전력 솔루션을 검증·승인했고 'Bloom이 이제 AI 온사이트 전력의 표준이 됐다'고 밝혔다. (bullish, 확신도: high)
- Bloom Energy는 2026년 연간 가이던스를 매출 39억~42억달러(중간값 기준 전년 대비 100% 성장), 비GAAP 매출총이익률 약 34%, 비GAAP 영업이익 8억~9억달러, 비GAAP EPS 2.55~2.85달러로 상향했다. (bullish, 확신도: high)
- Bloom Energy는 실적 전망치에 대한 위험요인으로 대형 부하 사이트向 설치 방식을 '컨설팅 전용' 모델로 전환하는 점과, 현재 제품·서비스 수주잔고(backlog)가 실제로 매출로 인식될 수 있을지 여부의 불확실성을 명시했다. (neutral, 확신도: medium)

## 근거
- KR Sridhar, Founder, Chairman and Chief Executive Officer of Bloom Energy, said, "The demand for Bloom Energy's solutions keeps accelerating every quarter as customers who traditionally defaulted to combustion technologies are now proactively choosing Bloom as a superior power solution. Today, all the major US hyperscalers and over a dozen US neoclouds, AI labs, and colocation data center operators have validated and approved our power solutions for their AI factories. Bloom is now a standard for AI onsite power."
- Bloom Energy is increasing its financial guidance for full-year 2026 as follows: •Revenue: $3.9B - $4.2B •Non-GAAP Gross Margin: ~34% •Non-GAAP Operating Income: $800M - $900M •Non-GAAP EPS: $2.55 - $2.85
- Raises full year 2026 revenue guidance to $3.9 billion – 4.2 billion, representing 100% year-over-year growth at the midpoint
- (14) evolution of Bloom's approach to installation to a consult only model particularly for large load sites
- (21) the ability of current product and service backlog to ultimately be recognizable as revenue
